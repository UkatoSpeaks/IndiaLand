    ...
    <div className="min-h-screen bg-[#F4F4F5]">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-10 h-[300px] md:h-[500px]">
          <div className="lg:col-span-2 relative rounded-[32px] overflow-hidden group">
            <img 
              src={plot.image} 
              alt={plot.title} 
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-10">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-28 space-y-6">
              {/* Agent Card */}
              <div className="bg-white rounded-[40px] p-8 border border-border-subtle shadow-xl shadow-primary/5">
                <div className="flex items-center gap-5 mb-8">
                  <div className="w-20 h-20 rounded-[28px] overflow-hidden bg-primary-light">
                    <img src={plot.agent.image} alt={plot.agent.name} className="w-full h-full object-cover" />
                  </div>
                  <div>
                    <h4 className="text-lg font-black text-text-primary">{plot.agent.name}</h4>
                    <p className="text-xs font-bold text-text-muted mb-2">{plot.agent.role}</p>
                    <span className="bg-verified/10 text-verified text-[10px] font-black px-2 py-1 rounded-lg">RERA CERTIFIED</span>
                  </div>
                </div>
                ...
                <div className="bg-section/50 rounded-3xl p-6 border border-border-subtle">
                  ...
                  <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <Button variant="primary" className="w-full h-12 rounded-xl text-xs font-black shadow-lg shadow-primary/10 mt-2">Get Details Via SMS</Button>
                  </form>
                </div>
              </div>
