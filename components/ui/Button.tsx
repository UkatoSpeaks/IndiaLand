  ...
  ({ className, variant = "primary", size = "md", ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "inline-flex items-center justify-center rounded-xl transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:pointer-events-none text-center leading-tight",
